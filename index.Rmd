...
+ What is `Rcpp`?
    + A library for R [@Eddelbuettel:Francois:2011:JSSOBK:v40i08] to build a more manageble interface between R and its C API, so that users are more easy to write C++ function for their R program.
