...
At the benchmark of only processing two processes, solution 2 seems to outperform `Rcpp` solution. But the latter *scales* considerably greater. Let's further examine this point.
...
There are other cases that you found solutions of existing packages lacking efficiency.
```{r, ex3:}


```

```{r ex3: rcpp_solution, cache=TRUE}
cppFunction('
